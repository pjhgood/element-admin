<template>
  <div class="header-title">
    ...
    <div class="flex-box">
      ...
      <screenfull id="screenfull" class="full-icon" />
    </div>
  </div>
</template>
